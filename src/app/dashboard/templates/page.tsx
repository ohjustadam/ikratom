...
/**
 * /dashboard/templates — preview every active campaign template
 * with the user's profile substituted in. Lets users see exactly
 * what their email will say before they click send on a campaign.
 *
...
export default async function TemplatesPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      <a href="/dashboard" className="text-xs text-zinc-500 hover:text-emerald-400">
        ← Dashboard
      </a>
